...
def choose_patch_coords(image_width, image_height, patch_size, patch_edge_size):
  width_minus_patch = image_width-patch_size
  height_minus_patch = image_height-patch_size
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    for step in xrange(FLAGS.max_steps):
      ...
      px, py = choose_patch_coords(image_width, image_height, patch_size, patch_edge_size)
